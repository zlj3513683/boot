...
require.config({
    baseUrl: 'http://img.kybimg.com/js/',
    ...
    shim: {
        ...
        'artDialog': {
            //ky库依赖的样式库的位置
            deps : ['css!../../css/ui-dialog']
        },
        'nicescroll' : {exports : 'IScroll'},

        'IScroll' : {exports : 'IScroll'},

        'selectSchool' : {
            //selectSchool的依赖
            deps : ['css!../../css/pc/widget/selectSchool']
        },

        'selectMajor' : {
            //selectMajor的依赖
            deps : ['css!../../css/pc/widget/selectMajor']
        }
    },
    ...
    paths: {
        ...
        'jquery1'       : './jquery/jquery-1.9.0.min',
        'jquery2'       : './jquery/jquery-2.1.4.min',
        ...
        //插件库
        'artDialog'     : './other_libs/artdialog-plus',
        'artTemplate'   : './other_libs/artTemplate',
        'IScroll'       : './other_libs/iscroll.min',
        'nicescroll'    : './other_libs/jquery.nicescroll.min',
        'selectSchool'  : './jquery/plugins/jq.selectSchool.min',
        'selectMajor'   : './jquery/plugins/jq.selectMajor.min',
        'swipe'         : './other_libs/swipe.min',
        'fullPage'      : './other_libs/fullPage.min',
        'lazyload'      : './other_libs/lazyload.min',
        'swiper'        : './other_libs/swiper.min',

        //业务
        //考研帮
        'wxqy'          : './app/m/bang/wxqy/main',
        '3g'            : './app/m/3g/script',
        '18rili'        : './app/m/bang/18rili',

        //bangstudy
        'bsvip'         : './app/pc/bangstudy/vip',
        'bs1v1'         : './app/pc/bangstudy/1v1',
        'bsexpert'      : './app/pc/bangstudy/expert',

        //帮学堂
        'bsindex'       : '../bangxuetang/js/pc/index',
        'bslogin'       : '../bangxuetang/js/pc/login',
        'bsvlist'       : '../bangxuetang/js/pc/vlist',
        'bsgoods'       : '../bangxuetang/js/m/goods',
        'bsvipm'        : '../bangxuetang/js/m/vip',
        'bstiku'        : '../bangxuetang/js/m/tiku.min',
        'bsucenter'     : '../bangxuetang/js/m/ucenter.min'


    },

    map: {
        //requirejs异步按需加载css样式表的插件位置
        '*': {
