...
import com.example.demo.sm2.SM3;
...
//        byte[] bb = Base64.decodeBase64("nbXbTHQUGrAzEywesR7Wpcd8D3ZS3wcVpnNdYGph/OU=");
//        String str = SM3.bytesToHexString(bb);
//        System.out.println();
//        System.out.println(str);
//        System.out.println(SM3.sm2PriKeyGet(str));
//        BigInteger d = SM3.sm2PriKeyGet(str);
        BigInteger d = random(n.subtract(new BigInteger("1")));
        SM2KeyPair keyPair = new SM2KeyPair(G.multiply(d).normalize(), d);

//        String key = "nbXbTHQUGrAzEywesR7Wpcd8D3ZS3wcVpnNdYGph/OU=";
//        SM2KeyPair key2 = new SM2KeyPair(G.multiply(key).normalize(), key);
//        G.multiply(key).normalize();
        byte[] pubKey = keyPair.getPublicKey().getEncoded(false);
        System.out.println("-------public-----------------------"+org.apache.tomcat.util.codec.binary.Base64.encodeBase64String(pubKey));
        byte[] priKey = keyPair.getPrivateKey().toByteArray();
        System.out.println("-------private-----------------------"+org.apache.tomcat.util.codec.binary.Base64.encodeBase64String(priKey));
