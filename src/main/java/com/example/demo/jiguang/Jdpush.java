...
//        PushPayload payload=buildPushObject_android_and_ios();
        String[] ids = {"1507bfd3f743e9a71c1"};
        PushPayload payload=buildPushObject_test(message,ids);
    ...
    public static PushPayload buildPushObject_test(String msg,String[] ids) {
        return PushPayload.newBuilder()
                .setPlatform(Platform.android_ios())
